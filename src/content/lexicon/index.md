...
The words — the profile's vocabulary. Read it by the meaning you arrive holding, or seen raw as the values themselves; then its quieter edges — the keywords that take no role, and the tokens a single presentation adds for itself.
